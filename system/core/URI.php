...
class URI extends BaseClass{
	...
	function _fetch_uri_string(){
		$uri = strtoupper($this->getConfig('uri_protocol'));
		...
		if ($uri == 'AUTO')	{
			...
			if ($u = $this->_detect_uri()){
				$this->_set_uri_string($u);
				return;
			}
	...
	{
		if  ($this->getConfig('url_suffix') != "")
		{
			$this->uri_string = preg_replace("|".preg_quote($this->getConfig('url_suffix'))."$|", "", $this->uri_string);
		}
	}
